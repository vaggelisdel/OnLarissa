...
public class GreeceCategory extends AppCompatActivity {

    private static String URL="https://www.onlarissa.gr/category/greece/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_greece_category );

        getSupportActionBar().setTitle("Greece News");
        ...
        new GreeceCategory.loadRecyclerViewData ().execute();
    }
    ...
    private class loadRecyclerViewData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog= new ProgressDialog(GreeceCategory.this);
